# Example: Using Java for Android with FusionAuth
This project contains an example project that illustrates using FusionAuth with Java for Android.
...
## Installation
* `git clone https://github.com/FusionAuth/fusionauth-quickstart-android-java.git`
* `cd fusionauth-quickstart-android-java`
* `docker compose up`
